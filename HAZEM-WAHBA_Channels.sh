...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/929/refs/heads/main/channels_backup_OpenBlackhole_20250913_HAZEMWAHBA-CIEFP.tar.gz"
